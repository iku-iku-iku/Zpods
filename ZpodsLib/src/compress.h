...
namespace zpods {
    ...
    constexpr static size_t OFFSET_BITS = 5;
    constexpr static size_t LENGTH_BITS = OFFSET_BITS;
    ...
    constexpr static size_t SEARCH_WINDOW_SIZE = 1 << 15;
    constexpr static size_t LOOK_AHEAD_WINDOW_SIZE = 1 << OFFSET_BITS;


    /*
     * @brief compress the src to dst
     * @param src is the pointer to the source data
     * @param src_size is the size of source data
     * @param dst is the pointer to the destination data
     * @return the size of compressed string
     */
     ...
     * @param src_size is the size of source data
     * @param dst is the pointer to the destination data
     * @return the size of decompressed string
     */
    size_t decompress(const char *src, size_t src_size, char *dst);
}
